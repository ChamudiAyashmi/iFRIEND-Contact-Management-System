...
public class UpdateContacts extends JFrame{
	...
	public UpdateContacts(){
		...
		titleLabel=new JLabel("UPDATE CONTACTS");
		...
		btnUpdate.setBounds(400,320,110,28);
		btnUpdate.setForeground(new Color(248, 205, 248));
		btnUpdate.setBackground(new Color(71, 39, 71));
		btnUpdate.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent evt){
				try{
					...
					String nameOrPhone=txtSearch.getText();
					int index=ContactsController.searchContacts(nameOrPhone);
					boolean isUpdateContacts=ContactsController.updateContacts(id,name,phoneNumber,companyName,salary,birthday,index);
